...
class NewsEndpointTests {
	...
	void updateNewsUpdatesAllowedFieldsAndUpdatedAtOnly() throws Exception {
		...
		long newsId = createdNews.get("newsId").asLong();
		LocalDateTime reportedAt = LocalDateTime.parse(createdNews.get("reportedAt").asText());
		LocalDateTime oldUpdatedAt = LocalDateTime.parse(createdNews.get("updatedAt").asText());
		...
		LocalDateTime updatedReportedAt = LocalDateTime.parse(updatedNews.get("reportedAt").asText());
		LocalDateTime newUpdatedAt = LocalDateTime.parse(updatedNews.get("updatedAt").asText());
